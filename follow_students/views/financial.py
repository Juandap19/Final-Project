            ...
            if student:
                ...
                if student.aux_transportation == "0":
                    if transportation_fun_result >= 0:
                        ...
                        scholarship.amount.save()
                        expense = Scholarship_expense.objects.create( student = student, scholarship = scholarship, money_quantity = scholarship.auxilio_transporte, accumulated_time =  6, selected_time = "Meses", type_mount = 'Transporte')  #Create a expense to One particular Student and save it
                        expense.save()
                    ...
                    for student in students_list:
                        ...
                        if student_pivot.aux_transportation == "0": 
                            if  transportation_fun_result >= 0:
                                ...
                                scholarship.amount.transporte = transportation_fun_result 
                                scholarship.amount.save()
                                expense = Scholarship_expense.objects.create( estudiante = student_pivot, scholarship = scholarship, money_quantity = scholarship.auxilio_transporte, accumulated_time =  6, selected_time = "Meses", type_mount = 'Transporte')  #Create a expense to One particular Student and save it
                                expense.save()
                            else:
                                scholarship.montos.save()
                                flag = False
