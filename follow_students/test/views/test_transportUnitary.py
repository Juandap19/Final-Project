...
class TransportTestCase(TestCase):
    ...
    def test_post_success_transport(self):
    ...
    def test_post_already_paid_transport(self):
        the_student = self.student
        the_student.aux_transportation = "4"
        the_student.save()
    ...
    def test_post_not_exist_id_transport(self):
        gastos_antes = Scholarship_expense.objects.count()
        response = self.client.post('/apoyo_financiero_Transporte/', {
